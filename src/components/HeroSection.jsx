                ...
                >
                    {[...Array(10)].map((_, i) => (
                        <span key={i} className="text-2xl font-bold mx-8">
                            ★ FULL STACK DEVELOPER ★ GENAI DEVELOPER ★ DSA
                        </span>
                    ))}
                </motion.div>
            </div>

            {/* Merged About Content ★ REACT JS ★ TAILWIND ★ DESIGN ★ NODE JS ★ PYTHON ★ JAVASCRIPT ★*/}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg font-medium leading-relaxed">
                            I’m a developer who thinks the internet needs fewer boring websites and more personality.
                            I started coding to break things, accidentally learned how to fix them, and now call it a career.
                            I build bold, memorable digital experiences—because “meh” was never an option.
                        </p>
                    </motion.div>
